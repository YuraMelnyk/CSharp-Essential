...
namespace StringFunctionality
{
    class Program
    {
        ...
        static void StringFunctionality()
        {
            ...
            Console.WriteLine("New first name: {0}", firstName.Replace("ra", ""));
            int indexOfChar = text.IndexOf(ch); 
            Console.WriteLine("Index of \'o\' symbol in \"hello world\" : {0}", indexOfChar);
            int indexOfSubstring = text.IndexOf(subString); 
            Console.WriteLine("Index of \'wor\' substring in \"hello world\" : {0}", indexOfSubstring);
            text = text.Trim();
            text = text.Trim(new char[] { 'd', 'h' });
            Console.WriteLine("Trim first and last letter in \"hello world\" : {0}", text); 
            Console.WriteLine();
        }
        #endregion
